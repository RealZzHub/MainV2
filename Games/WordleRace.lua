LPH_NO_VIRTUALIZE(function()
    ...
    local v8 = {[-1] = Color3.fromRGB(33, 33, 33), [0] = Color3.fromRGB(17, 17, 17), [1] = Color3.fromRGB(255, 204, 101), [2] = Color3.fromRGB(89, 214, 82)}
    local u1 = {}
            ...
            if u1[v] and u1[v] < v21[v] then
                ...
                for a, b in pairs(game:GetService("Players").LocalPlayer.PlayerGui.ScreenGui.Keyboard:GetDescendants()) do
                    if b.Name:lower() == v:lower() then
                        ...
                        game:GetService("TweenService"):Create(b, TweenInfo.new(0.5), {BackgroundColor3 = v8[Data[i]]}):Play()
                    end
                end
            end
        end
    ...
    function DoGameShitXD(Data, Word)
        if Data[1] == true then
            ...
            for i, v in pairs(Data[2]) do
                ...
                game:GetService("TweenService"):Create(v30, TweenInfo.new(0.1), {Color = v8[Data[2][i]]}):Play()
        ...
        if GuessData[1] then
            ...
            for i,v in pairs(GuessData[2]) do
                ...
                if v == 1 and not table.find(Data.YLetters, Letter) then
                    table.insert(Data.YLetters, {Letter, i})
                end
